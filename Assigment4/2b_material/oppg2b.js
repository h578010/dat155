...
// Bronse for program 1.
let mat1AmbientColor = vec4( 0.2125, 0.1275, 0.054, 1.0 );
let mat1DiffuseColor = vec4( 0.714, 0.4284, 0.18144, 1.0);
let mat1specularColor = vec4( 0.393548, 0.271906, 0.166721, 1.0 );
let mat1shininess = 25.6;
...
var shadedCube = function() {
    ...
    window.onload = function init() {
        ...
        var ambientProduct1 = mult(lightAmbient, mat1AmbientColor);
        var diffuseProduct1 = mult(lightDiffuse, mat1DiffuseColor);
        var specularProduct1 = mult(lightSpecular, mat1specularColor);
        ...
        normalLoc_p1 = gl.getAttribLocation(program1, "aNormal");
        gl.vertexAttribPointer(normalLoc_p1, 3, gl.FLOAT, false, 0, 0);
        gl.enableVertexAttribArray(normalLoc_p1);
        ...
        positionLoc_p1 = gl.getAttribLocation(program1, "aPosition");
        gl.vertexAttribPointer(positionLoc_p1, 4, gl.FLOAT, false, 0, 0);
        gl.enableVertexAttribArray(positionLoc_p1);
    ...
    function drawCube(program, side){
        ...
        if(side === rightSide){
            ...
            nMatrix = normalMatrix(modelViewMatrix, true);
            gl.uniformMatrix4fv( projectionMatrixLoc_left, false, flatten(projectionMatrix));
            gl.uniformMatrix3fv(normalMatrixLoc_left, false, flatten(nMatrix))
        }
